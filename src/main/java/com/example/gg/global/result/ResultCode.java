package com.example.gg.global.result;
...
public enum ResultCode {
    ...
    // Item
    ITEM_CREATE_SUCCESS("Q001", "상품 생성 성공"),
    ITEM_GET_SUCCESS("Q002", "상품 조회 성공"),
    ITEM_UPDATE_SUCCESS("Q002", "상품 수정 성공"),
    ITEM_DELETE_SUCCESS("Q002", "상품 삭제 성공"),
